...
// Base design system constants - BOLD, PREMIUM, TYPOGRAPHIC
const BASE_CONFIG = {
  typography: {
    fontFamily: bodyFont,
    h1: {
  ...
  shape: { borderRadius: 12 }, // Consistent 12px for modern SaaS feel
  spacing: 8,
};

// --- LIGHT THEME (Clean, airy, distinct Slate + Cobalt palette) ---
const LIGHT_THEME = createTheme({
  ...BASE_CONFIG,
  palette: {
    mode: 'light',
    primary: { main: '#2563eb', light: '#60a5fa', dark: '#1d4ed8', contrastText: '#ffffff' }, // Royal Blue
    secondary: { main: '#64748b', light: '#94a3b8', dark: '#475569', contrastText: '#ffffff' }, // Slate
    background: { default: '#f8fafc', paper: '#ffffff' }, // Crisp off-white bg, pure white cards
  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        containedError: {
          boxShadow: '0 4px 14px 0 rgba(239, 68, 68, 0.22)',
          '&:hover': { boxShadow: '0 6px 20px rgba(239, 68, 68, 0.18)' },
        },
        outlined: {
          borderWidth: '1.5px',
        ...
        text: {
          color: '#475569',
          '&:hover': { backgroundColor: 'rgba(15, 23, 42, 0.04)', color: '#0f172a' },
        },
      },
    },
    MuiCard: {
      ...
      styleOverrides: {
        root: {
          '& .MuiOutlinedInput-root': {
            ...
            '&.Mui-focused fieldset': { borderWidth: '2px', borderColor: '#2563eb' },
...
// --- DARK THEME (Deep Slate, Glowing Accents) ---
const DARK_THEME = createTheme({
  ...BASE_CONFIG,
  palette: {
    mode: 'dark',
    primary: { main: '#38bdf8', light: '#7dd3fc', dark: '#0284c7', contrastText: '#0f172a' }, // Neon Blue
    secondary: { main: '#94a3b8', light: '#cbd5e1', dark: '#64748b', contrastText: '#0f172a' },
    background: { default: '#020617', paper: '#0f172a' }, // Very deep black/blue background, slightly lighter cards
  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        containedError: {
          boxShadow: '0 4px 14px 0 rgba(248, 113, 113, 0.26)',
          '&:hover': { boxShadow: '0 6px 20px rgba(248, 113, 113, 0.2)' },
        },
        outlined: {
          borderWidth: '1.5px',
      ...
      styleOverrides: {
        root: {
          '& .MuiOutlinedInput-root': {
            ...
            '&.Mui-focused fieldset': { borderWidth: '2px', borderColor: '#38bdf8' },
            '&.Mui-focused': { boxShadow: '0 0 0 4px rgba(56, 189, 248, 0.1)' },
          },
        },
      },
    },
...
const HIGH_CONTRAST_THEME = createTheme({
  ...
  components: {
    MuiButton: {
      styleOverrides: {
        root: { borderRadius: 8, fontWeight: 700, py: 1.5, px: 4 },
        contained: {
          boxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.2)',
          '&:hover': { boxShadow: '0 6px 8px -1px rgba(0, 0, 0, 0.3)' },
        },
      },
    },
    MuiTextField: {
...
// Create responsive theme wrapper
